<script lang="ts">
	...
	import HeroInfo from '$lib/components/Sections/HeroInfo/HeroInfo.svelte';
...
<PageContent>
	...
	<InfoSection
		title="Service 1"
		text="<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam, nemo?</p> <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam, nemo?</p>"
		image={{
			src: "/images/featured-card-image-01.jpg"
		}}
	/>
	<InfoSection
		inverted
